	function validerRegistrerFlygning()
	{
		...
		{
			document.getElementById("section_bottom").style.fontWeight="900";	
			document.getElementById("section_bottom").style.color="red";	
			document.getElementById("section_bottom").innerHTML=feilmelding;
			return false;
		}  
